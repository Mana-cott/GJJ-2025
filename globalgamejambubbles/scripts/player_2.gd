# same as player 1 but uses gamepad inputs
...
func _physics_process(delta):
	...
	if Input.is_action_just_pressed("shoot_bullet_p2"):
	...
	# Trigger slide.
	if Input.is_action_just_pressed("crouch_p2") and velocity.x != 0 and is_on_floor():
		sliding = true
